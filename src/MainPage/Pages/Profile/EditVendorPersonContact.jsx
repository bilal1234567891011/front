...
const EditVendorPersonContact = ({ fetchVendors, editVendorId, pContact }) => {
  ...
  const [ personContact, setPersonContact ] = useState(pContact || [personContactTemplate]);
  ...
  return (
      <div id="edit_vendor_person_contact" className="modal custom-modal fade" role="dialog">
        <div
        ...
        >
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title">Edit Vendor Person Contact</h5>
              <button
                type="button"
                className="close"
                data-dismiss="modal"
