...
const AddVendor = ({ fetchVendors, editForm = false, editVendorId=null }) => {
  ...
  const addVendorData = async () => {
    console.log(vendorType,"vendorPic");
    if(!vendorType){
        ...
        <div className="col-sm-12">
              <form onSubmit={handleSubmit}>
                ...
                <div className='row'>
                  ...
                  <div className="col-md-6">
                    <div className="form-group">
                      ...
                      <input
                        name='email'
                        placeholder="Email." pattern="[a-zA-Z]{5}[0-9]{4}[a-zA-Z]{1}{@}" 
                ...
                <div className='row'>
                  <div className="col-md-6">
                    <div className="form-group">
                      <label className="col-form-label">Vendor Type <span className="text-danger">*</span></label>
                  ...
                  <div className="form-group">
                    ...
                    <div className="custom-file">
                      ...
                      >
                        ...
                        <span className=""> { currentFile?.name} {currentFile?.fileName} </span> : "Choose file"}
